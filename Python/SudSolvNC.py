...
resB = sf.initBin(rows,columns,res)
...
print('Starting Score: '+str(sum(ScoreR)[0]))

print('mat:')
print(res)
print('matB:')
print(resB)
print('Step counter: '+str(sf.StepCounter))
#print (ScoreR)
#print (ScoreC)
...
print(res)
sf.RowScoreVecInit(rows,columns,res,ScoreR)
print('New Score: '+str(sum(ScoreR)[0]))
...
print(sf.NumToBin(rows,columns, 123456))
print(sf.NumToBin(rows,columns, 1246))
print(sf.NumToBin(rows,columns, 3))


""" print(sf.NumToBin(rows,columns, 1))
print(sf.NumToBin(rows,columns, 2))
print(sf.NumToBin(rows,columns, 3))
print(sf.NumToBin(rows,columns, 4))
print(sf.NumToBin(rows,columns, 5))
print(sf.NumToBin(rows,columns, 6)) """